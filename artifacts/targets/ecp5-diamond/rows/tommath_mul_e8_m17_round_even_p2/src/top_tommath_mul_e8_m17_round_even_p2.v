...
(* keep_hierarchy = "yes" *)
module top_tommath_mul_e8_m17_round_even_p2 (
    input wire                  clk,
    input wire                  rst,
    ...
    wire [7:0]   dut_exp;
    wire                 dut_sign;
    wire [25:0] dut_y = {dut_sign, dut_exp, dut_mant};

    (* keep_hierarchy = "yes" *)
    FpxxMul u_dut (
        .io_input_valid(in_valid_r),
        .io_input_payload_a_mant(a_r[16:0]),
        .io_input_payload_a_exp(a_r[24:17]),
        .io_input_payload_a_sign(a_r[25]),
        .io_input_payload_b_mant(b_r[16:0]),
        .io_input_payload_b_exp(b_r[24:17]),
        .io_input_payload_b_sign(b_r[25]),
