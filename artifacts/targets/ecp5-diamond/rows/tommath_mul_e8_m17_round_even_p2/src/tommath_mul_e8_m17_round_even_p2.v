...
module FpxxMul (
  ...
  wire       [16:0]   _zz_n0_is_nan_1;
  wire                _zz_n0_is_nan_2;
  wire       [9:0]    _zz_n1_exp_mul;
  wire       [8:0]    _zz_n1_exp_mul_1;
  wire       [36:0]   _zz_n2_mant_mul_adj;
  wire       [17:0]   _zz__zz_n2_mant_mul_rounded_1;
  wire       [1:0]    _zz__zz_n2_mant_mul_rounded_1_1;
  wire       [18:0]   _zz__zz_n2_mant_mul_rounded;
  ...
  reg        [35:0]   n2_n1_mant_mul;
  wire                n2_isValid;
  wire       [35:0]   n1_mant_mul;
  reg        [17:0]   n1_n0_mant_b;
  reg        [17:0]   n1_n0_mant_a;
  wire       [9:0]    n1_exp_mul;
  reg        [16:0]   n1_n0_b_mant;
  reg        [7:0]    n1_n0_b_exp;
  reg                 n1_n0_b_sign;
  reg        [16:0]   n1_n0_a_mant;
  reg        [7:0]    n1_n0_a_exp;
  reg                 n1_n0_a_sign;
  wire                n0_sign_mul;
  wire       [17:0]   n0_mant_b;
  ...
  wire                n0_a_sign;
  wire                n0_valid;
  wire       [34:0]   n2_mant_mul_adj;
  reg        [17:0]   _zz_n2_mant_mul_rounded;
  wire                when_UInt_l238;
  reg        [17:0]   _zz_n2_mant_mul_rounded_1;
  wire                when_UInt_l219;
  wire       [17:0]   n2_mant_mul_rounded;
  ...
  assign _zz_n2_mant_mul_adj = ({n2_n1_mant_mul,1'b0} >>> n2_n1_mant_mul[35]);
  assign _zz__zz_n2_mant_mul_rounded_1_1 = {1'b0,1'b1};
  assign _zz__zz_n2_mant_mul_rounded_1 = {16'd0, _zz__zz_n2_mant_mul_rounded_1_1};
  assign _zz__zz_n2_mant_mul_rounded = ({1'b0,n2_mant_mul_adj[34 : 17]} + {1'b0,{17'h00000,1'b1}});
  assign _zz_n2_exp_mul_adj = ($signed(n2_n1_exp_mul) + $signed(_zz_n2_exp_mul_adj_1));
  assign _zz_n2_exp_mul_adj_2 = {1'b0,n2_n1_mant_mul[35]};
  assign _zz_n2_exp_mul_adj_1 = {{8{_zz_n2_exp_mul_adj_2[1]}}, _zz_n2_exp_mul_adj_2};
  assign _zz_n2_exp_mul_adj_4 = {1'b0,n2_mant_mul_rounded[17]};
  ...
  assign _zz_n0_is_nan_1 = 17'h00000;
  ...
  assign n0_is_nan = (((((&n0_a_exp) && (|n0_a_mant)) || ((&n0_b_exp) && (|n0_b_mant))) || (((n0_a_exp == _zz_n0_is_nan) && (n0_a_mant == _zz_n0_is_nan_1)) && ((&n0_b_exp) && (! _zz_n0_is_nan_2)))) || (((n0_b_exp == 8'h00) && (n0_b_mant == 17'h00000)) && ((&n0_a_exp) && (! (|n0_a_mant)))));
  ...
  assign n2_mant_mul_adj = _zz_n2_mant_mul_adj[34 : 0];
  assign when_UInt_l238 = (! n2_mant_mul_adj[18]);
  assign when_UInt_l219 = (n2_mant_mul_adj[17] && (|n2_mant_mul_adj[16 : 0]));
  always @(*) begin
    if(when_UInt_l219) begin
      _zz_n2_mant_mul_rounded_1 = ({1'b0,n2_mant_mul_adj[34 : 18]} + _zz__zz_n2_mant_mul_rounded_1);
    end else begin
      _zz_n2_mant_mul_rounded_1 = {1'b0,n2_mant_mul_adj[34 : 18]};
    end
  end
  ...
  always @(*) begin
    if(n2_n0_is_nan) begin
      io_result_payload_mant = 17'h1ffff;
    end else begin
      if(n2_n0_is_inf) begin
        io_result_payload_mant = 17'h00000;
      end else begin
        if(when_FpxxMul_l79) begin
          io_result_payload_mant = 17'h00000;
        end else begin
          if(when_FpxxMul_l81) begin
            ...
            io_result_payload_mant = n2_mant_mul_rounded[16:0];
          end
        end
      end
    end
