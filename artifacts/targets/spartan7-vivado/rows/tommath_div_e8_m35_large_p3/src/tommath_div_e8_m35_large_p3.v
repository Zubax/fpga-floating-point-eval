...
module FpxxDiv (
  ...
  wire       [38:0]   _zz_div_adj_p5;
  wire       [9:0]    _zz_exp_adj_p5;
  wire       [7:0]    _zz_exp_final_p6;
  wire       [35:0]   yh_p0;
  wire       [35:0]   yl_p0;
  wire       [35:0]   yh_m_yl_p0;
  wire       [9:0]    div_addr_p0;
  wire       [8:0]    exp_p0;
  wire                sign_p0;
  wire                op_a_zero_p0;
  wire                op_b_zero_p0;
  ...
  wire       [19:0]   div_val_p1;
  wire       [20:0]   recip_yh2_p1;
  ...
  reg        [34:0]   mant_a_p2;
  reg                 sign_p2;
  reg        [20:0]   recip_yh2_p2;
  reg        [9:0]    exp_full_p2;
  reg                 op_a_zero_p2;
  reg                 op_b_zero_p2;
  reg                 op_nan_p2;
  wire       [35:0]   mant_a_full_p2;
  wire       [71:0]   x_mul_yhyl_full_p2;
  wire       [38:0]   x_mul_yhyl_p2;
  wire                when_Misc_l42_2;
  reg                 p3_vld;
  reg                 sign_p3;
  reg        [38:0]   x_mul_yhyl_p3;
  reg        [20:0]   recip_yh2_p3;
  reg        [9:0]    exp_full_p3;
  reg                 op_a_zero_p3;
  reg                 op_b_zero_p3;
  reg                 op_nan_p3;
  ...
  reg                 p4_vld;
  reg                 sign_p4;
  reg        [38:0]   x_mul_yhyl_p4;
  reg        [20:0]   recip_yh2_p4;
  reg        [9:0]    exp_full_p4;
  reg                 op_a_zero_p4;
  reg                 op_b_zero_p4;
  reg                 op_nan_p4;
  wire       [59:0]   div_full_p4;
  wire       [38:0]   div_p4;
  ...
  assign _zz_exp_final_p6 = exp_adj_p6[7 : 0];
  initial begin
  ...
  assign yh_p0 = ({17'd0,_zz_yh_p0[35 : 17]} <<< 5'd17);
  assign yl_p0 = {19'd0, _zz_yl_p0};
  assign yh_m_yl_p0 = (yh_p0 - yl_p0);
  assign div_addr_p0 = (io_op_b_mant >>> 5'd25);
  assign exp_p0 = ($signed(_zz_exp_p0) - $signed(_zz_exp_p0_2));
  assign sign_p0 = (io_op_a_sign ^ io_op_b_sign);
  assign op_a_zero_p0 = (((io_op_a_exp == 8'h00) && (io_op_a_mant == 35'h000000000)) || (io_op_a_exp == 8'h00));
  assign op_b_zero_p0 = (((io_op_b_exp == 8'h00) && (io_op_b_mant == 35'h000000000)) || (io_op_b_exp == 8'h00));
  ...
  assign expBoundary = 10'h1a9;
  assign recip_exp_p0 = ((div_addr_p0 == 10'h000) ? 2'b00 : ((div_addr_p0 < expBoundary) ? 2'b01 : 2'b10));
  ...
  assign when_FpxxDiv_l167 = (div_p5[38 : 37] == 2'b01);
  assign when_FpxxDiv_l171 = (div_p5[38 : 36] == 3'b001);
  assign div_adj_p5 = _zz_div_adj_p5[34:0];
  assign exp_adj_p5 = ($signed(exp_full_p5) + $signed(_zz_exp_adj_p5));
  assign when_Misc_l42_5 = 1'b1;
  assign when_FpxxDiv_l198 = ((op_a_zero_p6 && op_b_zero_p6) || op_nan_p6);
  always @(*) begin
  ...
  always @(*) begin
    if(when_FpxxDiv_l198) begin
      div_final_p6 = 35'h000000000;
      div_final_p6[34] = 1'b1;
    end else begin
      if(when_FpxxDiv_l204) begin
        div_final_p6 = 35'h000000000;
      end else begin
  ...
  assign when_FpxxDiv_l204 = (($signed(10'h0ff) <= $signed(exp_adj_p6)) || op_b_zero_p6);
  assign when_FpxxDiv_l210 = ($signed(exp_adj_p6) <= $signed(10'h000));
