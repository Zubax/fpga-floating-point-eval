...
read_xdc {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/constraints.xdc}
...
read_verilog -sv {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/src/top_zkf_div_w8_m36_base.v}
synth_design -top top_zkf_div_w8_m36_base -part $part -mode out_of_context -flatten_hierarchy rebuilt
opt_design
place_design
route_design
report_utilization -file {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/utilization.rpt}
report_timing_summary -file {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/timing_summary.rpt} -max_paths 10 -nworst 10
...
set metrics_file {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/metrics.json}
...
puts $fh "}"
close $fh
write_checkpoint -force {/mnt/storage/test/zkf-vs-flopoco/artifacts/targets/spartan7-vivado/rows/zkf_div_w8_m36_base/post_route.dcp}
exit
