...
entity top_flopoco_div_we8_wf35_dummyfpga_plain_srt_42_f700 is
  port (
clk : in std_logic;
...
architecture rtl of top_flopoco_div_we8_wf35_dummyfpga_plain_srt_42_f700 is
...
begin
  ...
  u_dut : entity work.flopoco_div_we8_wf35_dummyfpga_plain_srt_42_f700
    port map (
  clk => clk,
  X => X_r,
  Y => Y_r,
