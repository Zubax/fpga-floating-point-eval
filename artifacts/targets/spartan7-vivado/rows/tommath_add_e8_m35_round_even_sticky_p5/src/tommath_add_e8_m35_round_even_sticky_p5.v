...
module FpxxAdd (
  ...
  reg                 n5_n0_is_inf;
  reg                 n5_n0_is_nan;
  reg        [7:0]    n5_n4_exp_add_adj;
  reg        [5:0]    n5_n4_lz;
  reg        [38:0]   n5_n4_mant_add_adj;
  ...
  reg        [40:0]   n3_n2_mant_b_opt_inv;
  reg        [40:0]   n3_n2_mant_a_opt_inv;
  ...
  always @(posedge clk) begin
    ...
    n5_n0_is_nan <= n4_n0_is_nan;
    n5_n0_is_inf <= n4_n0_is_inf;
    n5_n2_sign_add <= n4_n2_sign_add;
    n5_n4_lz <= n4_lz;
    n5_n4_exp_add_adj <= n4_exp_add_adj;
    n5_n4_mant_add_adj <= n4_mant_add_adj;
  end
