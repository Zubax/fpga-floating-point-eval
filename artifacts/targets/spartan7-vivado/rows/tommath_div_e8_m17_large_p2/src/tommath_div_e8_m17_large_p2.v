...
module FpxxDiv (
  ...
  assign div_addr_p0 = (io_op_b_mant >>> 4'd8);
  ...
  assign expBoundary = 9'h0d5;
  assign recip_exp_p0 = ((div_addr_p0 == 9'h000) ? 2'b00 : ((div_addr_p0 < expBoundary) ? 2'b01 : 2'b10));
  ...
  assign div_p4 = div_full_p4[41 : 21];
