...
entity top_flopoco_div_we8_wf17_zynq7000_native_srt_87_f300 is
  port (
clk : in std_logic;
X_i : in std_logic_vector(27 downto 0);
Y_i : in std_logic_vector(27 downto 0);
R_o : out std_logic_vector(27 downto 0)
  );
end entity;

architecture rtl of top_flopoco_div_we8_wf17_zynq7000_native_srt_87_f300 is
  signal X_r : std_logic_vector(27 downto 0);
  signal Y_r : std_logic_vector(27 downto 0);
  signal R_dut : std_logic_vector(27 downto 0);
  signal R_r : std_logic_vector(27 downto 0);
...
begin
  ...
  u_dut : entity work.flopoco_div_we8_wf17_zynq7000_native_srt_87_f300
    port map (
  clk => clk,
  X => X_r,
  Y => Y_r,
