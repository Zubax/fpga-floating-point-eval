...
(* keep_hierarchy = "yes" *)
module top_tommath_mul_e8_m35_round_even_p2 (
    input wire                  clk,
    input wire                  rst,
    ...
    FpxxMul u_dut (
        ...
        .io_input_payload_a_mant(a_r[34:0]),
        .io_input_payload_a_exp(a_r[42:35]),
        .io_input_payload_a_sign(a_r[43]),
        .io_input_payload_b_mant(b_r[34:0]),
        .io_input_payload_b_exp(b_r[42:35]),
        .io_input_payload_b_sign(b_r[43]),
