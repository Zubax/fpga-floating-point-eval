...
entity top_flopoco_mul_we8_wf35_zynq7000_native_f500 is
  port (
clk : in std_logic;
...
architecture rtl of top_flopoco_mul_we8_wf35_zynq7000_native_f500 is
...
begin
  ...
  u_dut : entity work.flopoco_mul_we8_wf35_zynq7000_native_f500
    port map (
  clk => clk,
  X => X_r,
  Y => Y_r,
