...
entity top_flopoco_add_we8_wf17_dummyfpga_plain_single_f300 is
  port (
clk : in std_logic;
...
architecture rtl of top_flopoco_add_we8_wf17_dummyfpga_plain_single_f300 is
...
begin
  ...
  u_dut : entity work.flopoco_add_we8_wf17_dummyfpga_plain_single_f300
    port map (
  clk => clk,
  X => X_r,
  Y => Y_r,
