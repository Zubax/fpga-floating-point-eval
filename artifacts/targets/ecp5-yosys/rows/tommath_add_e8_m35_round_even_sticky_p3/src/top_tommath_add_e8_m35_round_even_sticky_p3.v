...
(* keep_hierarchy = "yes" *)
module top_tommath_add_e8_m35_round_even_sticky_p3 (
    input wire                  clk,
    input wire                  rst,
    ...
    FpxxAdd u_dut (
        ...
        .io_op_payload_a_mant(a_r[34:0]),
        .io_op_payload_a_exp(a_r[42:35]),
        .io_op_payload_a_sign(a_r[43]),
        .io_op_payload_b_mant(b_r[34:0]),
        .io_op_payload_b_exp(b_r[42:35]),
        .io_op_payload_b_sign(b_r[43]),
